    ...
    public function handle()
    {
        ...
        if ($result_arr != null) {
            ...
            if (count($employee_ids) > 0) {
                $employees = DB::table('employee')->whereIn("employee.employee_id", $employee_ids)->leftJoin('employee_attendance', 'employee_attendance.employee_id', '=', 'employee.id')->selectRaw('"employee.id", "employee.employee_id","max(students_attendance.access_time) as access_time"')->get();
